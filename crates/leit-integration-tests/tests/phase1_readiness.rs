...
proptest! {
    ...
    fn test_lexical_scorers_match_reference_models(
        bm25_term_frequency in 1u32..50u32,
        bm25_doc_length in 1u32..500u32,
        bm25_avg_doc_length in 0.1f32..1_000.0f32,
        bm25_doc_count in 1u32..10_000u32,
        bm25_doc_frequency in 1u32..10_000u32,
        bm25f_fields in vec((1u32..25u32, 1u32..500u32, 0.1f32..4.0f32), 1..4),
        bm25f_avg_doc_length in 0.1f32..1_000.0f32,
        bm25f_doc_count in 1u32..10_000u32,
        bm25f_doc_frequency in 1u32..10_000u32,
    ) {
