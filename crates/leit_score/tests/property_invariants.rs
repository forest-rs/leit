...
proptest! {
    ...
    fn bm25_returns_finite_scores_for_valid_stats(
        term_frequency in 1_u32..100_u32,
        doc_length in 1_u32..5_000_u32,
        avg_doc_length in 0.1_f32..5_000.0_f32,
        doc_count in 1_u32..100_000_u32,
        doc_frequency in 1_u32..100_000_u32,
    ) {
    ...
    fn bm25_returns_zero_for_invalid_collection_stats(
        term_frequency in 0_u32..10_u32,
        doc_length in 0_u32..1_000_u32,
        doc_count in 0_u32..100_u32,
        doc_frequency in 0_u32..100_u32,
        avg_doc_length in prop_oneof![Just(0.0_f32), Just(f32::INFINITY), Just(f32::NEG_INFINITY), Just(f32::NAN)],
    ) {
        let scorer = Bm25Scorer::new();
        let score = scorer.score(&ScoringStats {
            term_frequency,
    ...
    fn bm25f_returns_finite_scores_for_valid_field_stats(
        fields in vec((1_u32..50_u32, 1_u32..500_u32, 0.1_f32..5.0_f32), 1..6),
        avg_doc_length in 0.1_f32..2_000.0_f32,
        doc_count in 1_u32..100_000_u32,
        doc_frequency in 1_u32..100_000_u32,
    ) {
        prop_assume!(doc_frequency <= doc_count);
    ...
    fn bm25_score_is_monotonic_in_term_frequency(
        term_frequency in 1_u32..100_u32,
        extra_frequency in 1_u32..100_u32,
        doc_length in 1_u32..5_000_u32,
        avg_doc_length in 0.1_f32..5_000.0_f32,
        doc_count in 1_u32..100_000_u32,
        doc_frequency in 1_u32..100_000_u32,
    ...
    fn bm25_score_is_antitonic_in_document_length(
        term_frequency in 1_u32..100_u32,
        doc_length in 1_u32..5_000_u32,
        extra_length in 1_u32..5_000_u32,
        avg_doc_length in 0.1_f32..5_000.0_f32,
        doc_count in 1_u32..100_000_u32,
        doc_frequency in 1_u32..100_000_u32,
    ) {
    ...
    fn bm25_score_is_antitonic_in_document_frequency(
        ...
        doc_length in 1_u32..5_000_u32,
        avg_doc_length in 0.1_f32..5_000.0_f32,
        doc_count in 2_u32..100_000_u32,
        doc_frequency in 1_u32..99_999_u32,
        extra_frequency in 1_u32..1_000_u32,
    ) {
        prop_assume!(doc_frequency < doc_count);
    ...
    fn bm25f_score_is_monotonic_in_term_frequency(
        term_frequency in 1_u32..50_u32,
        extra_frequency in 1_u32..50_u32,
        field_length in 1_u32..500_u32,
        weight in 0.1_f32..5.0_f32,
        avg_doc_length in 0.1_f32..2_000.0_f32,
        doc_count in 1_u32..100_000_u32,
        doc_frequency in 1_u32..100_000_u32,
    ) {
